...
<?php
        $bundle = "../jquery-ui/development-bundle";
	print "<link rel='stylesheet' href='$bundle/themes/base/jquery.ui.all.css'>";
        print "<script type='text/javascript' src='../jquery-ui/js/jquery-1.9.0.js'></script>";
	...
	print "<script src='$bundle/ui/jquery.ui.dialog.js'></script>";
