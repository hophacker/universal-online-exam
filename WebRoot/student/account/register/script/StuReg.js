 var post_url = '../../logic/private/class/LoadAndCheck.php';
    ...
    $("#st_major").change(function() {
        ...
        if($(this).val() != -1) {
            $.post(post_url,{
                ...
                $("#st_class").html(option);
            },'json');
        }
    });

    $("#submit_bt").click(function(){
        var st_user,st_pwd,st_name,st_depart,st_major,st_class,st_no,st_mail,st_grade,st_birth,st_edu;
    //实现AJAX 注册，暂时未写;
        check_flag = true;
        CheckUser();
        CheckPwd();
        ...
        if(check_flag == true) {
            ...
            st_no = $("#st_No").val(); st_mail = $("#st_mail").val();
            ...
            st_no:st_no, st_mail:st_mail, st_grade:st_grade, st_birth:st_birth, st_edu:st_edu}, function(data){
                if(data.flag==1) {
                    alert('注册成功,前往登陆页面！');
